...
<section class="py-32 border-b border-white/5">
	<div class="max-w-[1400px] mx-auto px-6">
		<div class="text-center mb-16">
			<span class="text-sm text-gray-400 block mb-3 font-medium">Services Tailored to Your Stage</span>
			<h2 class="text-4xl md:text-5xl font-serif mb-10">How We Support Startups</h2>
			
			<div class="inline-flex flex-wrap justify-center gap-1 p-1 bg-surface rounded-full border border-white/10">
				<button class="px-5 py-2.5 rounded-full bg-white text-black text-sm font-medium shadow-sm">Early Stage</button>
				<button class="px-5 py-2.5 rounded-full text-gray-400 hover:text-white text-sm font-medium transition-colors">Growth Stage</button>
				<button class="px-5 py-2.5 rounded-full text-gray-400 hover:text-white text-sm font-medium transition-colors">Pre-IPO</button>
				<button class="px-5 py-2.5 rounded-full text-gray-400 hover:text-white text-sm font-medium transition-colors">Product Counsel</button>
			</div>
		</div>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-white/10 rounded-xl overflow-hidden bg-surface">
			...
			<div class="p-12 lg:p-20 flex flex-col justify-center">
				<h3 class="text-3xl font-serif mb-6">Early Stage Startups</h3>
				<p class="text-gray-400 mb-10 leading-relaxed text-lg font-light">
					Get your foundational contracts right from the start. We help first-time founders with initial customer terms, privacy policies, and essential agreements that scale with your business.
				</p>
				<a href="#" class="text-sm text-gray-400 hover:text-white transition-colors inline-flex items-center gap-1 group">
					Solutions for Early Stage Startups <ChevronRight size={12} class="group-hover:translate-x-0.5 transition-transform" />
				</a>
			</div>
		</div>
	</div>
