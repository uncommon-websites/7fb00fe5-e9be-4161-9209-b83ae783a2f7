...
<footer class="py-24 text-sm">
	<div class="max-w-[1400px] mx-auto px-6">
		<div class="grid grid-cols-2 md:grid-cols-6 gap-12 mb-24">
			<!-- Logo -->
			<div class="col-span-2 md:col-span-2">
				<a href="/" class="text-4xl font-serif tracking-tight text-white">H</a>
			</div>
		...
		<div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 text-gray-500 text-xs">
			<p>Copyright © 2025 Harvey AI Corporation. All rights reserved.</p>
